 ...
 */
public class ActivityPatternComparisonTest extends UsefulTestCase {
    ...
    final String dataPath = "E:\\Workspace\\Guidewire\\Inspections\\testData";
    ...
    protected void doTest(String testName, String hint) throws Throwable {
        myFixture.configureByFile(testName + ".gs");
        myFixture.enableInspections(ActivityPatternComparison.class);
...
//        myFixture.checkResultByFile(testName + ".after.java");
    ...
    public void test() throws Throwable {
        doTest("CollectionWhereCountCode", "Use equals()");
    }
