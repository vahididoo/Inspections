 ...
 */
public class CollectionWhereSingleTest extends InspectionsTestBase {
...
//        ((GosuElementVisitor)new CollectionWhereFirst().buildVisitor(problemsHolderMock, false)).visitBeanMethodCallExpression(beanMethod1);
        ...
        for (PsiElement beanMethod : beanMethods) {
            if ( beanMethod instanceof GosuBeanMethodCallExpressionImpl ) {
                ((GosuElementVisitor)new CollectionWhereSingle().buildVisitor(problemsHolderMock, false)).visitBeanMethodCallExpression((GosuBeanMethodCallExpressionImpl)beanMethod);
            }
        }
