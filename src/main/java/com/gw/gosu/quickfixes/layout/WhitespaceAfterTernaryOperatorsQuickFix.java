 ...
 */
public class WhitespaceAfterTernaryOperatorsQuickFix extends LocalQuickFixAndIntentionActionOnPsiElement {
    private static final Logger LOG = Logger.getInstance('#' + MethodHandles.lookup().lookupClass().getName());


    public WhitespaceAfterTernaryOperatorsQuickFix (final PsiElement elem) {
        super(elem);
    }
