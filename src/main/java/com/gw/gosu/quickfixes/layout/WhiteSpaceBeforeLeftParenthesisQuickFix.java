 ...
 */
public class WhiteSpaceBeforeLeftParenthesisQuickFix extends LocalQuickFixAndIntentionActionOnPsiElement {
    private final Logger LOG = Logger.getInstance('#' + MethodHandles.lookup().lookupClass().getName());

    public WhiteSpaceBeforeLeftParenthesisQuickFix(final PsiElement elem) {
        super(elem);
    }
    ...
    public final String getText() {
        String quickfixTooltipsName = "Add or remove ne whitespace before left parenthsis";
    ...
    public final String getFamilyName() {
        return "White Space Before Left Parenthsis";
    }
