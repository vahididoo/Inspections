...
import com.gw.gosu.quickfixes.layout.WhiteSpaceWithinParenthesesQuickFix;
...
/**
 * Checks for whitespaces within parentheses based on IntelliJ settings Gosu Code Style Spaces.
 */
public class WhiteSpaceWithinParentheses extends BaseLocalInspectionTool {
    @Nls
    @NotNull
    @Override
    ...
    public final String getDisplayName() {
        return SampleBundle.message("layout.name.whitespacewithinparentheses");
    }
    ...
    public final String getShortName() {
        return "WhiteSpaceWithinParentheses";
    }
        ...
        return new GosuElementVisitor() {
            ...
            public void visitElement(final PsiElement elem) {
                if (elem instanceof GosuTokenImpl) {
                    ...
                    if (token.getText().equals("(") || token.getText().equals(")")) {
                        ...
                        intelliJSettingsCodeStyleGosuSpaces = Common.spacesWithinParentheses(elem);
            ...
            public void checkSpaceBeforeAndAfterOperator(final PsiElement elem) {
                ...
                if (elem.getText().equals("(")) {
                    if (intelliJSettingsCodeStyleGosuSpaces && checkAfter(elem)) {
                        holder.registerProblem(elem, SampleBundle.message("layout.fix.tooltip.whiteSpacewithinparentheses"), new WhiteSpaceWithinParenthesesQuickFix(elem));
                    }
                    else if (!intelliJSettingsCodeStyleGosuSpaces && !checkAfter(elem)) {
                        holder.registerProblem(elem, SampleBundle.message("layout.fix.tooltip.whiteSpacewithinparentheses"), new WhiteSpaceWithinParenthesesQuickFix(elem));
                    }
                }
