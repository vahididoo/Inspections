 ...
 */
public class CollectionWhereFirst extends BaseLocalInspectionTool {
    ...
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder holder, boolean isOnTheFly) {
        return new GosuElementVisitor() {
            ...
            public void visitBeanMethodCallExpression(GosuBeanMethodCallExpressionImpl callExpression) {
                ...
                while (lefter != null && !"first".equals(lefter.getReferenceName())) {
                    lefter = lefter.getQualifier();
                }

                //method lookup from right to left, first locate ".first()"
                if (lefter!=null && "first".equals(lefter.getReferenceName()) && lefter.getTypeParameterList()==null) {
