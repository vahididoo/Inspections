...
import com.aviva.gosu.quickfix.CollectionWhereCountQuickFix;
 ...
 */
public class CollectionWhereCount extends BaseLocalInspectionTool {
    ...
    public String getDisplayName() {
        return "Use hasMatch(cond) instead of where(cond).Count";
    }
    ...
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder holder, boolean isOnTheFly) {
        return new GosuElementVisitor() {
            ...
            public void visitFieldAccessExpression(GosuFieldAccessExpressionImpl propertyMemberAccessExpression) {
                ...
                //first identify the first(), which may not be the last method call
                ...
                if (lefter!=null && "Count".equals(lefter.getReferenceName()) && isInInterestedComparison(lefter)) {
                    ...
                    if ("where".equals(firstCaller.getReferenceName()) && isCollection(firstCaller.getQualifier())) {
                        holder.registerProblem(propertyMemberAccessExpression, "Use collections.hasMatch(cond)", ProblemHighlightType.GENERIC_ERROR_OR_WARNING);
